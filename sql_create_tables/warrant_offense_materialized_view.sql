CREATE MATERIALIZED VIEW public.warrant_offenses
AS
...
WITH DATA;
ALTER TABLE public.warrant_offenses
OWNER TO acohen;
GRANT ALL ON TABLE public.warrant_offenses TO acohen;
GRANT SELECT ON TABLE public.warrant_offenses TO readaccess;

CREATE INDEX pub_warrant_offenses_pk_idx
ON public.warrant_offenses
USING btree (pk);
